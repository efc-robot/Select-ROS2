    ...
    namespace fastrtps
    {
        namespace rtps
        {
            ...
            public:
                 ...
                 */
                LocatorSelector(const int user_entries_allocation = 0)
                {
                    std::cout << user_entries_allocation << endl;
                }

                LocatorSelector(
                    const ResourceLimitedContainerConfig &entries_allocation)
                    : entries_(entries_allocation), selections_(entries_allocation), last_state_(entries_allocation)
                {
                }
                ...
                bool add_entry_tmp(
                    LocatorSelectorEntry *entry, int last_state_tmp)
                {
                    last_state_.push_back(last_state_tmp);
                    return entries_.push_back(entry) != nullptr;
                }

                void fresh_selections()
                {
                    int tmpi = 0;
                    selections_.clear();
                    for (auto &entry : entries_)
                    {
                        selections_.push_back(tmpi);
                        tmpi++;
                    }
                }
                ...
                class iterator : public LocatorsIterator
                {
                ...
                public:
                    ...
                    iterator(
                        ...
                        : locator_selector_(other.locator_selector_), current_(other.current_)
                    {
                    }
