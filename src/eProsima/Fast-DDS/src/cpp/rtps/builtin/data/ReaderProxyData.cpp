...
void write_txt_Reader(std::string txt_file, std::string data)
{
    std::ofstream ofs;
    ofs.open(txt_file, std::ios::app);
    ofs << data << std::endl;
    ofs.close();
}
    ...
    namespace fastrtps
    {
        namespace rtps
        {
...
#if HAVE_SECURITY
                  ,
                  security_attributes_(0UL), plugin_security_attributes_(0UL)
#endif // if HAVE_SECURITY
                  ,
                  remote_locators_(max_unicast_locators, max_multicast_locators), m_userDefinedId(0), m_isAlive(true), m_topicKind(NO_KEY), m_type_id(nullptr), m_type(nullptr), m_type_information(nullptr)
            {
...
#if HAVE_SECURITY
                  ,
                  security_attributes_(readerInfo.security_attributes_), plugin_security_attributes_(readerInfo.plugin_security_attributes_)
#endif // if HAVE_SECURITY
                  ,
                  m_guid(readerInfo.m_guid), remote_locators_(readerInfo.remote_locators_), m_key(readerInfo.m_key), m_RTPSParticipantKey(readerInfo.m_RTPSParticipantKey), m_typeName(readerInfo.m_typeName), m_topicName(readerInfo.m_topicName), m_userDefinedId(readerInfo.m_userDefinedId), m_isAlive(readerInfo.m_isAlive), m_topicKind(readerInfo.m_topicKind), m_type_id(nullptr), m_type(nullptr), m_type_information(nullptr), m_properties(readerInfo.m_properties)
            {
                ...
                const ReaderProxyData &readerInfo)
            {
                ...
                m_topicKey = readerInfo.m_topicKey;
                ...
                bool write_encapsulation) const
            {
                ...
                {
                    ParameterString_t p(fastdds::dds::PID_TOPIC_KEY, 0, m_topicKey);
                    if (!fastdds::dds::ParameterSerializer<ParameterString_t>::add_to_cdr_message(p, msg))
                    {
                        return false;
                    }
                ...
                if (m_qos.m_durabilityService.send_always() || m_qos.m_durabilityService.hasChanged)
                {
                    if (!fastdds::dds::QosPoliciesSerializer<DurabilityServiceQosPolicy>::add_to_cdr_message(m_qos.m_durabilityService, msg))
                    {
                        return false;
                    }
                }
                ...
                {
                    if (!fastdds::dds::QosPoliciesSerializer<DisablePositiveACKsQosPolicy>::add_to_cdr_message(m_qos.m_disablePositiveACKs, msg))
                    {
                        return false;
                    }
                }
                ...
                if (m_qos.type_consistency.send_always() || m_qos.type_consistency.hasChanged)
                {
                    if (!fastdds::dds::QosPoliciesSerializer<TypeConsistencyEnforcementQosPolicy>::add_to_cdr_message(m_qos.type_consistency, msg))
                    {
                        return false;
                    }
                }
                ...
                bool is_shm_transport_available)
            {
                                      ...
                                      &are_shm_default_locators_present](CDRMessage_t *msg, const ParameterId_t &pid, uint16_t plength)
                {
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<DeadlineQosPolicy>::read_from_cdr_message(m_qos.m_deadline, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<LatencyBudgetQosPolicy>::read_from_cdr_message(m_qos.m_latencyBudget, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<LivelinessQosPolicy>::read_from_cdr_message(m_qos.m_liveliness, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<ReliabilityQosPolicy>::read_from_cdr_message(m_qos.m_reliability, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<LifespanQosPolicy>::read_from_cdr_message(m_qos.m_lifespan, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<UserDataQosPolicy>::read_from_cdr_message(m_qos.m_userData, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<TimeBasedFilterQosPolicy>::read_from_cdr_message(m_qos.m_timeBasedFilter, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<OwnershipQosPolicy>::read_from_cdr_message(m_qos.m_ownership, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<PresentationQosPolicy>::read_from_cdr_message(m_qos.m_presentation, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<PartitionQosPolicy>::read_from_cdr_message(m_qos.m_partition, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<TopicDataQosPolicy>::read_from_cdr_message(m_qos.m_topicData, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    {
                        if (!fastdds::dds::QosPoliciesSerializer<GroupDataQosPolicy>::read_from_cdr_message(m_qos.m_groupData, msg, plength))
                        {
                            return false;
                        }
                        break;
                    ...
                    case fastdds::dds::PID_TOPIC_KEY:
                    {
                        ParameterString_t p(pid, plength);
                        if (!fastdds::dds::ParameterSerializer<ParameterString_t>::read_from_cdr_message(p, msg,
                                                                                                         plength))
                        ...
                        m_topicKey = p.getName();
                        std::string temp_topicKey = p.getName();
                        if (temp_topicKey.length() == 13)
                        {
                            std::string txt_file_2 = "/home/nics/Fast-DDS/test2.txt";
                            write_txt_Reader(txt_file_2, temp_topicKey);
                        }
                        break;
                    }
