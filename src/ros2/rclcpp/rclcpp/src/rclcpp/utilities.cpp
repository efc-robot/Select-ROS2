...
init(int argc, char const * const argv[], const InitOptions & init_options)
{
  ...
  //init_options is the options for the rclcpp context
  //init_options.impl.rmw_init_options.implementation_identifier:0x7ffff6ff8d00 "rmw_fastrtps_cpp"
  //也可以直接看init_options.impl.rmw_init_options
